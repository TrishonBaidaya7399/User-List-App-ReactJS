...
<footer className="footer items-center p-4 bg-base-100 bg-opacity-60 text-neutral-content px-4 md:px-12 lg:px-[100px]">
  ...
  <a href="#" className="text-xl text-blue-400 hover:text-blue-800 duration-300"><FaFacebookF/></a>
      <a href="#" className="text-xl text-blue-400 hover:text-blue-600 duration-300"><FaTwitter/></a>
      <a href="#" className="text-xl text-blue-400 hover:text-red-600 duration-300"><FaYoutube/></a>
  </nav>
</footer>
        </div>
    );
